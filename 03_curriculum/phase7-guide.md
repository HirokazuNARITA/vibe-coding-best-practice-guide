...
> 3. 「Settings」→「Project」→「Project API Key」からAPIキーをコピーする
>    - `phc_` で始まるキー
> 4. 同じページで「Host」を確認する
>    - US Cloud: `https://us.i.posthog.com`
>    - EU Cloud: `https://eu.i.posthog.com`
> 5. `.env.local` に以下を追加する
>
> | キー                       | 値                                          |
> | -------------------------- | ------------------------------------------- |
> | `NEXT_PUBLIC_POSTHOG_KEY`  | コピーしたAPIキー（`phc_...`）              |
> | `NEXT_PUBLIC_POSTHOG_HOST` | ホストURL（例：`https://us.i.posthog.com`） |
>
